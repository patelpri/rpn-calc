...
<meta content="rpn.py · master · c4cs / rpn" property="og:title">
...
<meta content="https://gitlab.eecs.umich.edu/c4cs/rpn/blob/master/rpn.py" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="rpn.py · master · c4cs / rpn" property="twitter:title">
...
<title>rpn.py · master · c4cs / rpn · GitLab</title>
...
<meta name="csrf-token" content="2n92BZ79iMIPm1UfWBlqP2wUkNKHWsq2WnTxMOHvkAQGF1CeZCjYLZmRxUARFwCVh3stX797dxqKjYKHql9R+A==" />
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/c4cs/rpn/blob/master/rpn.py">Repository</a></h2>
</li>
</ul>
</div>
...
<input type="hidden" name="path" id="path" value="rpn.py" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/c4cs/rpn/blob/master/rpn.py"><strong>rpn.py</strong>
</a></li>
</ul>
</div>
...
<div class="btn-group" role="group"><a class="btn js-blob-blame-link" href="/c4cs/rpn/blame/master/rpn.py">Blame</a><a class="btn" href="/c4cs/rpn/commits/master/rpn.py">History</a><a class="btn js-data-file-blob-permalink-url" href="/c4cs/rpn/blob/72d02e0bee9d40fade03fff8d2be56d460c72788/rpn.py">Permalink</a></div>
</div>
</div>
...
<button class="btn btn-clipboard btn-transparent prepend-left-5" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent prepend-left-5" data-title="Copy file path to clipboard" data-clipboard-text="{&quot;text&quot;:&quot;rpn.py&quot;,&quot;gfm&quot;:&quot;`rpn.py`&quot;}" type="button" title="Copy file path to clipboard" aria-label="Copy file path to clipboard"><svg><use xlink:href="/assets/icons-24aaa921aa9e411162e6913688816c79861d0de4bee876cf6fc4c794be34ee91.svg#duplicate"></use></svg></button>
<small>
773 Bytes
</small>
</div>
...
<div class="btn-group" role="group"><button class="btn btn btn-sm js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn btn-sm js-copy-blob-source-btn" data-title="Copy source to clipboard" data-clipboard-target=".blob-content[data-blob-id=&#39;b2ddc25612d879a217553a948d697c314b2fa40b&#39;]" type="button" title="Copy source to clipboard" aria-label="Copy source to clipboard"><svg><use xlink:href="/assets/icons-24aaa921aa9e411162e6913688816c79861d0de4bee876cf6fc4c794be34ee91.svg#duplicate"></use></svg></button><a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Open raw" data-container="body" href="/c4cs/rpn/raw/master/rpn.py"><i aria-hidden="true" data-hidden="true" class="fa fa-file-code-o"></i></a><a download="rpn.py" class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Download" data-container="body" href="/c4cs/rpn/raw/master/rpn.py?inline=false"><svg><use xlink:href="/assets/icons-24aaa921aa9e411162e6913688816c79861d0de4bee876cf6fc4c794be34ee91.svg#download"></use></svg></a></div>
<div class="btn-group" role="group"><a class="btn js-edit-blob  btn-sm" href="/c4cs/rpn/edit/master/rpn.py">Edit</a><a class="btn btn-default btn-sm" href="/-/ide/project/c4cs/rpn/edit/master/-/rpn.py">Web IDE</a></div>
</div>
</div>



<div class="blob-viewer" data-type="simple" data-url="/c4cs/rpn/blob/master/rpn.py?format=json&amp;viewer=simple">
...
<h3 class="page-title">Replace rpn.py</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/c4cs/rpn/update/master/rpn.py" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="lSwzW2BJKspW+Fu0uiIxqIpmbKHsog7IvgN/lKpgsjdJRBXAmpx6JcDyy+vzLFsCYQnRLNSDs2Ru+gwj4dBzyw==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-11e1bf54a4625711730ca4ece39af449">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-11e1bf54a4625711730ca4ece39af449" class="form-control js-commit-message" placeholder="Replace rpn.py" required="required" rows="3">
Replace rpn.py</textarea>
</div>
</div>
</div>
